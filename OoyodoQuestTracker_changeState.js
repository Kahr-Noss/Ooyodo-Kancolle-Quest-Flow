$(function () {
  ...
  function changeQuestState(quest){
    ...
    displayBubbleMessage(`Admiral, which state do you want to set quest ${quest}?
      ...
      $(".MSG_change_quest_state_btn").click(function(){
        ...
        $(".MSG_change_quest_state_btn").click(function(){
          ...
          // if the quest is set to completed, checke la suite to put to pending quests with qll requirements completed
    ...
    function checkQuestUpdates(questCookie){
      ...
      if (inconsistencies.length > 0){
        ...
        <br>${getQuestsInState(ALL_QUEST_STATE_TMP,"pending")}`
        ...
        questCookie.timeStamp = moment().utcOffset("+09:00").format();
        questCookie.progress = getSaveStringForCookie();
        setCookie('user_quests',JSON.stringify(questCookie),365);
      ...
      function resizeWindow(){
        ...
        if($(window).width() <= 1000){height -= 60;} //if the window is too small, the header become 60 px higher
