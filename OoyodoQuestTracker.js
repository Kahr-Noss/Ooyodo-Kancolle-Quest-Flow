...
// TODO change the creation of table
    ...
    function createQuestBox(questCode){
      ...
      <div class="cellDiv" style=" height:75px;  top:0px; left:0px; ${quest.period !== "once" ? "width: calc(100% - 30px); padding-right:30px":"width:100%;"}">
      ...
      <div class="cellDiv" style="width:100%; height:148px;  top:75px; left:0px; position:relative">
      <button type="button" class="complete_btn" id='QL_complete_btn_${questCode}'>set as completed</button>
...
$(".QL_questBox").dblclick(function(e){
  var quest = $(this).attr("id").split('_')[2];
  $("#QL").hide();
  $("#FC").show('fast');
