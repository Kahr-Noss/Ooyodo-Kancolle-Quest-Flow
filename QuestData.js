const ALL_QUESTS_LIST = {
  ...
  "A70":{
    ...
    "content":"Have ONLY Asashio Kai Ni/Asashio Kai Ni D as flagship, Michishio, Ooshio and Arashio in your fleet.※ doesn't have to be the main fleet※ If you put Asashio into your fleet, remodel her and then activate the quest you can't clear it for some reason. Either remove her from the fleet and put her back in, or turn the quest off and on again.",
    "ressources":{
      "F":"200",
      "A":"200",
      "S":"0",
  ...
  "B78":{
    ...
    "content":"Sortie a fleet with Isonami, Uranami, Ayanami and Shikinami to World 1-5, and score at least an A-Rank at the boss node.※Because of the branching rules you can have only these four in your fleet. Enjoy the pre-boss compass trolling.",
    "ressources":{
      "F":"300",
      "A":"300",
      "S":"300",
  ...
  "B88":{
    ...
    "content":"Sortie a (F)BB(V) as flagship, 1 other (F)BB(V) and up to 4 additional ships to World 3-3 and obtain an S-Rank at the boss node.※Due to the branching rules you're required to bring at least 2 CV(L).※You will be prompted to choose between one of the two equipment rewards, so choose wisely.",
    "ressources":{
      "F":"0",
      "A":"800",
      "S":"0",
  ...
  "B95":{
    ...
    "content":"Sortie a Fleet with Suzuya Kai Ni as the flagship.Sortie to World 5-1, 5-3 and obtain A rank or higher victories at the boss nodes. ※The CVL version cannot complete the quest. Must be CAV.",
    "ressources":{
      "F":"300",
      "A":"300",
      "S":"300",
  ...
  "B96":{
    ...
    "content":"Sortie a Fleet with Suzuya Carrier Kai Ni as the flagship.Sortie to World 6-2, 6-5 and obtain S-rank victories at the Boss nodes. ※The CAV version cannot complete the quest. Must be CVL.",
    "ressources":{
      "F":"0",
      "A":"1000",
      "S":"0",
  ...
  "G5":{
    ...
    "content":"Prepare 5500 steel & 2500 bauxite, then perform 2 successful modernizations on a CV(B) each with 5 carriers as material.※Modernisation target must be a CV(B). CVL and AV do not count.※Modernisation materials can be CV or CVL. AV does not count.※You don't have to modernise the same carrier twice.※You must use 5 CV(L) at once for each modernisation attempt.※The specified resources will be consumed upon clearing the quest.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "F22":{
    ...
    "content":"Prepare a Skilled Crew Member in your inventory, have Houshou equipped a rank 7 Type 0 Fighter Model 21 as secretary , then scrap 2 Type 0 Fighter Model 21 and a Type 96 Fighter. One is consumed in the process. ※Equipment must be unlocked.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
    ...
    "period":"monthly",
    "needs":{
      "E":[["Type 0 Fighter Model 21",1],["Type 0 Fighter Model 21",2],["Type 96 Fighter",1]],
      "S":["Houshou"],
      "O":[["Skilled Crew Member",1]]
    }
  },
  "F23":{
    "Jp":"試製航空艤装の追加試作",
  ...
  "F35":{
    ...
    "content":"Have Houshou equipped with a Type 96 Fighter that is both rank 7 and ★max as secretary . 2 Medals is consumed in the process. ※Consumes the equipment. ※Equipment must be unlocked.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "F36":{
    ...
    "content":"Have Shimakaze as secretary equipped with a ★max 61cm Quintuple (Oxygen) Torpedo Mount and a ★max 61cm Triple (Oxygen) Torpedo Mount. 2 Medals is consumed in the process.※ Consumes the equipment.※Equipment must be unlocked.",
    "ressources":{
      "F":"0",
      "A":"600",
      "S":"0",
  ...
  "F37":{
    ...
    "content":"Have two 7.7mm Machine Guns & two Type 96 Fighters in your inventory, and scrap two Drum Canisters.※Equipment must be unlocked.※Consumes the equipment. ※It doesn't matter whether you scrap the drums before or after procuring the other items.",
    "ressources":{
      "F":"200",
      "A":"0",
      "S":"0",
  ...
  "F38":{
    ...
    "content":"Have two 7.7mm Machine Guns & two Type 99 Dive Bombers in your inventory.※Equipment must be unlocked.※Consumes the equipment.",
    "ressources":{
      "F":"0",
      "A":"200",
      "S":"0",
  ...
  "F39":{
    ...
    "content":"Have a Type 96 Land-based Attack Aircraft & two Type 97 Torpedo Bombers in your inventory, and scrap two Type 0 Fighters Model 21.※Equipment must be unlocked. ※Consumes the equipment.※It doesn't matter whether you scrap the fighters before or after procuring the other items.",
    "ressources":{
      "F":"250",
      "A":"250",
      "S":"0",
  ...
  "F40":{
    ...
    "content":"Have a Type 1 Land-based Attack Aircraft & two Tenzan in your inventory. ※Equipment must be unlocked. ※Consumes the equipment. ※The land-based aircraft's proficiency level carries over to the reward.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "F41":{
    ...
    "content":"Have 750 fuel, 750 ammo, two Drum Canisters, one Type 91 AP Shell in your inventory, and scrap one Type 3 Shell.※Equipment must be unlocked. ※Consumes all the resources and equipment. ※It doesn't matter whether you scrap the shell before or after procuring the other items.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "F42":{
    ...
    "content":"Have 5000 Furniture Coins, two 25mm Twin Autocannon Mount, two 25mm Triple Autocannon Mount in your inventory, and scrap one 25mm Single Autocannon Mount. ※Equipment must be unlocked.※Consumes all the resources and equipment. ※It doesn't matter whether you scrap the autocannon before or after procuring the other items.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "F44":{
    "Jp":"「特注家具」の調達",
    "En":" Procurement of Custom-made furniture",
    "content":"Scrap 2 12.7cm Twin High-angle Gun Mount, prepare 5000 furniture coin, 2 14cm Single Gun Mount and 2 15.2cm Single Gun Mount (all are consumed upon Quest completion). ※Equipment must be unlocked.",
    "ressources":{
      "F":"0",
      "A":"100",
      "S":"0",
  ...
  "F45":{
    ...
    "content":"Have one Type 1 Land-based Attack Aircraft, two Saiun in your inventory, and scrap two Type 0 Reconnaissance Seaplane. ※Equipment must be unlocked. ※Consumes all the equipment.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "F46":{
    ...
    "content":"Scrap 3 Shiden Kai 2, have 2 New Technology Aircraft Blueprint and 1 Ne Type Engine prepared. ※The New Technology Aircraft Blueprints & Ne Type Engine are consumed upon quest completion",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "F47":{
    ...
    "content":"Scrap 3 Type 0 Fighter Model 52. Prepare 2 Reppuu, 2 Ryuusei, and 8000 steel. ※Equipment must be unlocked.※Consumes the equipment.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "F49":{
    ...
    "content":"Equip a Prototype Seiran in first slot and a Zuiun (631 Air Group) in second slot on either I-401, I-13 or I-14 as secretary. ※Equipment must be unlocked.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "F50":{
    ...
    "content":"Prepare 3x 61cm Quadruple (Oxygen) Torpedo Mount, 3x Type 93 Passive Sonar and 120 development materials in your inventory. Scrap 4x 61cm Triple Torpedo Mount. ※Equipment must be unlocked.",
    "ressources":{
      "F":"0",
      "A":"100",
      "S":"0",
  ...
  "F51":{
    ...
    "content":"Prepare one Skilled Crew Member in your inventory, equip a Type 2 Seaplane Fighter Kai that is both rank 7 and ★max in the first slot of your Secretary Ship, then scrap 2 Type 0 Fighter Model 21 and 2 Zuiun. One Skilled Crew Member is consumed in the process. ※Equipment must be unlocked.",
    "ressources":{
      "F":"0",
      "A":"0",
      "S":"0",
  ...
  "C2":{
    ...
    "requires":[],
    "unlocks":["C3", "C4", "B58", "B77", "C10", "C11", "F44", "F48"],
    "period":"daily",
    "needs":{}
  },
  "C3":{
  ...
  "Bw5":{
    ...
    "requires":["Bw2"],
    "unlocks":["Bw6", "Bw7", "F12", "A71", "B72", "F41"],
    "period":"weekly",
    "needs":{}
  },
  "Bw6":{
